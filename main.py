...
class LimitCalculator:
    ...
    def __init__(self):
        ...
        self.symbol_label = tk.Label(self.root, text="Symbol")                   #Symbol
        ...
        self.limit_label = tk.Label(self.root, text="Limit")                     #Limit
        ...
        self.expression_label = tk.Label(self.root, text="Expression")           # Expression
        ...
        self.calculate_button = tk.Button(self.root, text="Calculate Limit", command=self.calculate_limit)       # Calculate Button
